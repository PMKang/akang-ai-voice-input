...
PACKAGE_BASENAME="${AKANG_PACKAGE_BASENAME:-AkangVoiceInput-v${APP_VERSION}-${BUILD_TIMESTAMP}}"
...
ARCHIVE_PATH="$ARCHIVE_DIR/${PACKAGE_BASENAME}-${PACKAGE_SUFFIX}.zip"
DMG_PATH="$ARCHIVE_DIR/${PACKAGE_BASENAME}-macos.dmg"
