---
title: "给 AI 语音输入法做了几处小优化，实际体验顺了不少——悬浮窗、拖动和位置记忆"
author: "阿康"
cover: "assets/v1.8.0-article-cover.png"
digest: "一次由遮挡问题引发的产品细节复盘：让悬浮窗可以拖动、收起，并记住你放下的位置。"
...
![文章封面](assets/v1.8.0-article-cover.png)
...
<section style="margin: 22px 0 28px; padding: 20px 22px; border-radius: 8px; border: 1px solid #f06a4a; background: #fff8f5;">
  ...
  <p style="margin: 0 0 8px; color: #a63d2f; font-size: 14px; font-weight: 700; line-height: 1.8;">阿康的第101篇原创文章</p>
  <p style="margin: 0; color: #333333; font-size: 16px; font-weight: 700; line-height: 1.9;"><span style="color: #f05a47;">阿康导读：</span>这次升级没有增加什么大而全的功能，主要解决一个每天都能碰到的小麻烦：实时语音输入条挡住了正在使用的应用。我们从自动避让想到直接拖动，又把收起、位置记忆和状态切换顺了一遍，看看这些小改动为什么会让高频使用舒服很多。</p>
</section>
...
![语音输入悬浮窗挡住 ChatGPT 的模型选择菜单](assets/v1.8.0-chatgpt-model-picker-obscured.png)
...
![从自动避让到直接拖动的产品决策示意图](assets/v1.8.0-drag-decision-story.png)
...
![展开态的拖动把手与悬停提示](assets/v1.8.0-expanded-drag-handle.png)
...
![收起态保留波形、短文字和展开入口](assets/v1.8.0-compact-drag-handle.png)
...
![展开、收起和处理状态共用同一个位置锚点](assets/v1.8.0-position-anchor-states.png)
